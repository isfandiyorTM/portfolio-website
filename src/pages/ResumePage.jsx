const RESUME = {
  ...
  summary:
    "Flutter developer with 3+ years of experience building polished cross-platform mobile applications for iOS and Android. Passionate IT mentor who has guided 450+ students from zero to shipping live web and mobile projects.",
  experience: [
    {
      role:    "IT Mentor & Platform Founder",
      company: "Rahimov Devs · rahimovdevs.tech",
      period:  "2022 — Present",
      points: [
        "Mentored 450+ students from absolute zero to shipping live web and mobile projects.",
        "Designed a structured curriculum: HTML → CSS → JavaScript → React, with real PR reviews on every project.",
        "Published every student project to rahimovdevs.tech — real audience, real portfolio, real motivation.",
        "Maintained a 5-star mentor rating across all students.",
      ],
    },
    {
      ...
      period:  "2021 — Present",
      points: [
        "Built Cho'ntak — a personal finance app with Clean Architecture + BLoC, 100% offline, 3 languages, biometric lock.",
        "Built Hoji Jalyuzi — a business management app for a local company with order and inventory tracking.",
        "Delivered cross-platform iOS & Android applications from a single Flutter codebase.",
        "Applied Clean Architecture: domain, data, and presentation layers fully separated per feature.",
      ],
    },
  ],
  projects: [
