...
function TerminalCursor() {
  ...
  return (
    <span style={{
      ...
      marginLeft: "4px", verticalAlign: "middle", transition: "background 0.1s",
    }} />
  );
}

export default function Hero() {
  const { displayed, done } = useTypewriter("> Flutter Mobile Developer & IT Mentor", 800);
  ...
  return (
    <section id="home" className="grid-bg" style={{
      ...
      <div style={{
        maxWidth: "1100px", margin: "0 auto", width: "100%", position: "relative",
      }}>
        {/* Decorative spinner */}
        <div style={{
          ...
          borderRadius: "50%", border: "1px solid var(--green-dark)",
        ...
        <div style={{ maxWidth: "680px" }}>
          <div className="section-label" style={{ animation: "fadeUp 0.6s ease both" }}>
          ...
          <p style={{
            ...
            Building polished cross-platform mobile experiences with Flutter.
            Mentoring the next generation of developers across Uzbekistan and beyond.
          </p>
